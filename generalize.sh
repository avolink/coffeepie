...
# run it with root privileges, the VM will be cleaned and shut down,
...
# without the user needing to manually type the network configuration to get Internet access.
