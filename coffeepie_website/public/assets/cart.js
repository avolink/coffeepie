        ...
        itemsHtml += `
            <div class="cart-item-row">
                <div class="cart-item-info">
                    <img src="${escapeHtml(item.image)}" class="cart-item-image" onerror="this.src='/assets/557674_3c3a2d29a9434c33a754d6cac7b98b98.png';">
...
document.addEventListener('click', (e) => {
    ...
    if (btn) {
        ...
        let priceEl = [...(container?.querySelectorAll('span') || [])].find(s => s.innerText.includes('COP'));
