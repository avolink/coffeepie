...
var LANGUAGES = [
    ...
    { locale: 'EL-GR', flag: '<svg class="language-flag" viewBox="0 0 24 18"><rect width="24" height="2" fill="#0D5EAF"/><rect y="2" width="24" height="2" fill="#FFF"/><rect y="4" width="24" height="2" fill="#0D5EAF"/><rect y="6" width="24" height="2" fill="#FFF"/><rect y="8" width="24" height="2" fill="#0D5EAF"/><rect y="10" width="24" height="2" fill="#FFF"/><rect y="12" width="24" height="2" fill="#0D5EAF"/><rect y="14" width="24" height="2" fill="#FFF"/><rect y="16" width="24" height="2" fill="#0D5EAF"/><rect width="9.6" height="10" fill="#0D5EAF"/><rect x="3.3" y="2" width="3" height="6" fill="#FFF"/><rect x="2.05" y="3.75" width="5.5" height="2.5" fill="#FFF"/></svg>' },
...
function setupHamburgerMenu() {
    ...
    try {
        ...
        menuHtml += '<a href="/pricing" style="color:white;text-decoration:none;font-size:26px;font-weight:400;letter-spacing:0.5px;">PRECIOS</a>';
        menuHtml += '<a href="/store" style="color:white;text-decoration:none;font-size:26px;font-weight:400;letter-spacing:0.5px;">TIENDA</a>';
        menuHtml += '<a href="/tutorials" style="color:white;text-decoration:none;font-size:26px;font-weight:400;letter-spacing:0.5px;">TUTORIALES</a>';
        menuHtml += '<a href="/about" style="color:white;text-decoration:none;font-size:26px;font-weight:400;letter-spacing:0.5px;">ACERCA DE</a>';
