...
- Goal: Initial Public Offering (IPO) or Tokenization (TRC20) by the end of 2035 (tokenization is B shares like, with right to valuation and dividends, but with no right to vote in directive decisions), for the benefit of highly conscious investors and stakeholders. No single individual nor entity will have controlling stakes. We will always be guided by stoic and ethical principles, and our success will be measured by our positive impact on society and the environment, not just by our profits. PIE tokens are convertible into platform credits via a one-way burning mechanism: holders may irreversibly retire their tokens (and all associated economic/voting rights) in exchange for immediately spendable credits, analogous to a company repurchasing B shares with service obligations instead of cash.
