        ...
        StackView {
            ...
            Connections {
                ...
                function onLoginFailed(error) {
                    labelLoginError.text = tr.tr("Credenciales inválidas")
            ...
            Image {
                ...
                Button {
                    ...
                    Text {
                        ...
                        height: 30
                        color: "#eaeaea"
                        text: tr.tr("Restablecer contraseña")
                        font.pixelSize: 24
                        horizontalAlignment: Text.AlignHCenter
            ...
            TextField {
                ...
                selectionColor: "#908f8f"
                selectedTextColor: "#ffffff"
                placeholderText: tr.tr("Contraseña")
                inputMask: ""
                font.pointSize: 20
                background: Rectangle { color: "transparent" }
                onFocusChanged: if (focus) selectAll()
