...
Item {
    ...
    StackView {
        ...
        Image {
            ...
            Connections {
                ...
                function onBalanceChanged() {
                    txtBalance.text = api.getBalanceFormatted()
                    _text.text = api.getAccountTypeText()
                }
            ...
            Connections {
                target: tr
                function onLangChanged() { /* forces QML binding re-evaluation */ }
            }
            ...
            StackView {
                ...
                width: 1920
                height: 824
                initialItem: "StackViewBasic.qml"
            }
        }
        ...
        Switch {
            ...
            onToggled: if (checked) { stackViewHome.push("StackViewAdvanced.qml") }
                       else { stackViewHome.pop() }
        }
        Label {
            id: labelAdvanced
            x: 1013
        ...
        Button {
            ...
            Text {
                ...
                color: "#c18b44"
                text: tr.tr("Créditos Gratis")
                font.pixelSize: 14
            }
            Connections {
                target: buttonFreeCredits
                onClicked: {
                    api.requestFreeCredits()
                    stackView.push("Ads_Display.qml")
                }
            }
        }
        ...
        TextField {
            ...
            placeholderText: tr.tr("Buscar máquina")
            inputMask: ""
            font.pointSize: 20
        ...
        MouseArea {
            ...
            MouseArea {
                ...
                Rectangle {
                    ...
                    ScrollView {
                        ...
                        Text {
                            ...
                            height: 511
                            color: "#f2f8f9"
                            text: tr.tr("Activa el modo avanzado y toma el control total de tus máquinas, sácale el máximo partido a nuestro Ecosistema en todo tipo de situación, optimiza diversas máquinas con configuraciones específicas según el uso o aplicación. Estudia, trabaja, crea, disfruta, diseña, programa, vende, gestiona, automatiza, comprime, compila, despliega y mucho, MUCHO MÁS!...")
                            font.pixelSize: 16
                            wrapMode: Text.WordWrap
                        }
                    }
                ...
                Rectangle {
                    ...
                    ScrollView {
                        ...
                        Text {
                            ...
                            height: 511
                            color: "#f2f8f9"
                            text: tr.tr("Crea una cuenta nueva, no necesitas saldo para comenzar a usar el servicio (Ads). Puedes crear una máquina a tu gusto o usar la que viene creada por defecto, es gratis y fácil de usar (Requiere Conexión a Internet).")
                            font.pixelSize: 16
                            wrapMode: Text.WordWrap
                        }
                    }
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        height: 487
                        color: "#f2f8f9"
                        text: tr.tr("Especificaciones Técnicas Porción Coffee Pie®:\n\nPWR: 1 Wh\nCPU: 1 vCore\nRAM: 1 GB\nSSD: 8 GB\nNET: 8 Mbps\nHDD: 125 GB\nGPU: 125 MB\nRES: 15 vMPX/s\nIA: 3 TOPS (INT8)")
                        font.pixelSize: 30
                        horizontalAlignment: Text.AlignHCenter
                    }
                }
            ...
            Button {
                ...
                Text {
                    ...
                    visible: true
                    color: "#f2f8f9"
                    text: tr.tr("Definición de Porción")
                    font.pixelSize: 22
                    horizontalAlignment: Text.AlignLeft
                    verticalAlignment: Text.AlignVCenter
                }
            ...
            Button {
                ...
                Text {
                    ...
                    visible: true
                    color: "#f2f8f9"
                    text: tr.tr("Términos y Condiciones")
                    font.pixelSize: 22
                    horizontalAlignment: Text.AlignLeft
                    verticalAlignment: Text.AlignVCenter
                }
            ...
            Button {
                ...
                Text {
                    ...
                    visible: true
                    color: "#f2f8f9"
                    text: tr.tr("Política de Privacidad")
                    font.pixelSize: 22
                    horizontalAlignment: Text.AlignLeft
                    verticalAlignment: Text.AlignVCenter
                }
